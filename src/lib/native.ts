...
export const haptics = {
  ...
  impact: () => vibrate(18),
  /** Успех: тренировка завершена, задание отправлено. */
  success: () => vibrate([14, 60, 26]),
  /**
   * Личный рекорд — свой рисунок, а не общий «успех».
   *
   * Два коротких удара и один длинный: рука узнаёт рекорд раньше, чем глаз
   * доходит до экрана. Пока он вибрировал как обычное подтверждение,
   * единственный особенный момент тренировки ощущался как любой другой.
   */
  record: () => vibrate([12, 50, 12, 50, 44]),
