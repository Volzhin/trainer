...
export interface AppState {
  ...
  lang?: Lang
  /**
   * Знаки, о которых человеку уже сказали, — по каждому аккаунту отдельно.
   *
   * Сам знак нигде не хранится: он выводится из тренировок, замеров и
   ...
   * тестовый клиент — разные люди со своими знаками, и общий список гасил
   * бы поздравления одного отметками другого.
   */
  seen_marks?: Record<string, string[]>
  /**
