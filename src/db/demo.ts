...
const BASE_WEIGHT: Record<string, number> = {
  'Жим штанги лежа': 72.5,
  'Жим гантелей на наклонной скамье': 26,
  'Жим штанги стоя': 42.5,
  'Отведение рук через стороны стоя': 10,
  'Разгибание на трицепс с канатом с верхнего блока': 25,
  'Становая тяга': 105,
  'Подтягивания широким хватом': 5,
  'Тяга штанги в наклоне прямым хватом 35-40 градусов': 60,
  'Отведение в наклоне на заднюю дельту': 30,
  'Сгибание на бицепс сидя (с супинацией)': 14,
  'Приседания со штангой на спине': 87.5,
  'Жим платформы с широкой постановкой ног': 140,
  'Сгибание голени лежа': 40,
  'Ягодичный мост со штангой': 70,
  'Икры в тренажере стоя': 55,
}
